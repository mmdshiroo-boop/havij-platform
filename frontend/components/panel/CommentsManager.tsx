...
> = {
  pending: {
    ...
    variant: "secondary",
    icon: Clock,
    bgClass: "bg-amber-100/80 dark:bg-amber-500/20",
  ...
  approved: {
    ...
    variant: "default",
    icon: CheckCircle2,
    bgClass: "bg-emerald-100/80 dark:bg-emerald-500/20",
  ...
  rejected: {
    ...
    variant: "destructive",
    icon: XCircle,
    bgClass: "bg-red-100/80 dark:bg-red-500/20",
  ...
  return (
    <div className="space-y-6 p-4 md:p-6" dir="rtl">
      ...
      >
        ...
        <div className="relative flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2">
            <Badge
              variant="secondary"
              className="px-3 py-1.5 text-xs rounded-xl bg-muted/50 border-border/50 font-bold"
            >
      ...
      <div className="flex flex-col sm:flex-row gap-3 items-center justify-between">
        <div className="relative w-full sm:w-80">
          ...
          <Input
            ...
            className="pr-9 rounded-xl bg-background border-border/60 focus:border-primary/40 focus:ring-primary/30 h-11"
          />
        </div>
      ...
      {Object.keys(groupedComments).length === 0 ? (
        <Card className="rounded-2xl border-dashed border-border/60 bg-muted/5">
        ...
        Object.entries(groupedComments).map(([adId, group]) => (
          ...
          >
            <Card className="border-border/50 shadow-sm hover:shadow-md transition-all rounded-2xl overflow-hidden mb-5">
              <CardHeader className="pb-3 border-b border-border/20 bg-muted/10">
                <CardTitle className="text-base font-black flex items-center justify-between">
                  ...
                  <Badge
                    variant="outline"
                    className="rounded-lg font-normal border-border/50 bg-background/50"
                  >
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                          ...
                          {isAdmin && (
                            <Badge
                              className={`gap-1.5 px-3 py-1.5 rounded-lg text-xs font-bold border-0 ${statusConfig.bgClass} ${statusConfig.textClass}`}
                            >
                        ...
                        {replyTo === comment._id && (
                          ...
                          >
                            ...
                            <div className="flex justify-end gap-2">
                              ...
                              <Button
                                size="sm"
                                className="rounded-lg text-xs gap-1.5 bg-primary text-primary-foreground hover:bg-primary/90 shadow-sm shadow-primary/20"
