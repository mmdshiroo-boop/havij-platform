  ...
  return (
    <div className="space-y-6 w-full" dir="rtl">
      ...
      <motion.div
        ...
        className="relative overflow-hidden rounded-2xl bg-gradient-to-l from-primary/15 via-primary/5 to-transparent p-6 border border-primary/10 shadow-md backdrop-blur-md bg-card/60"
      >
        ...
        <div className="relative flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          <div className="flex flex-wrap items-center gap-2">
            <Button
              ...
              className="gap-1.5 rounded-xl text-xs font-bold border-border/60"
            >
              {isDownloading === "excel" ? (
            ...
            <Button
              ...
              className="gap-2 rounded-xl h-10 px-5 text-xs font-bold bg-primary hover:bg-primary/90 shadow-md shadow-primary/20"
            >
        ...
        <Card className={kpiCardClass}>
          <CardContent className="p-5">
            <div className="flex items-center justify-between">
              ...
              <div className="p-2.5 bg-emerald-100 dark:bg-emerald-500/20 text-emerald-600 rounded-xl">
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        {loading ? (
          ...
          <div className="col-span-full text-center py-16 text-muted-foreground bg-card/30 border border-dashed border-border/50 rounded-2xl">
          ...
          agents.map((agent, i) => (
            ...
            >
              <Card className="backdrop-blur-md bg-card/60 border border-border/40 shadow-md hover:shadow-lg transition-all group overflow-hidden">
                <CardContent className="p-5">
          ...
          >
            ...
            >
              ...
              >
                ...
                <div className="space-y-1.5">
                  <label className="text-xs font-bold text-muted-foreground flex items-center gap-1">
                    <Phone className="w-3 h-3 text-primary" /> شماره تماس (نام
                    کاربری) *
                  </label>
                  <Input
                    type="tel"
                ...
                <div className="flex gap-2 pt-3 border-t border-border/40">
                  <Button
                    ...
                    className="flex-1 h-10 rounded-xl text-sm font-extrabold gap-2 bg-primary hover:bg-primary/90 shadow-md shadow-primary/20"
                  >
                    {isSubmitting ? (
